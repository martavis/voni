	...
	return (
		<div className="about page">
			<Head>
				...
				<title>Shipping | Voni Aesthetics</title>
				<meta
					name="description"
				...
				<meta property="og:title" content="Shipping | Voni Aesthetics" />
				<meta
					property="og:description"
					content="The apparel line of the future is here. Astro Collection available now for purchase."
				/>
				<meta property="og:type" content="website" />
				<meta property="og:url" content="https://voni.us/shipping" />
				<meta
					property="og:image"
			...
			{shipping && (
				<div className="section-custom-border" dangerouslySetInnerHTML={{ __html: shipping.body }}></div>
			)}
