        ...
        <div className="profile page">
            ...
            <div className="section-custom-border">
                <div className="profile-info"> 
                    <CustomInput placeholder="First Name" value={fname} type="input" onChange={(event: React.ChangeEvent<HTMLInputElement>) => {setFName(event.target.value);}} />
                    <CustomInput placeholder="Last Name" value={lname} type="input" onChange={(event: React.ChangeEvent<HTMLInputElement>) => {setLName(event.target.value);}} />
