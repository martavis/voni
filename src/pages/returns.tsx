	...
	return (
		<div className="about page">
			<Head>
				...
				<title>Returns | Voni Aesthetics</title>
				<meta
					name="description"
				...
				<meta property="og:title" content="Returns | Voni Aesthetics" />
				<meta
					property="og:description"
					content="The apparel line of the future is here. Astro Collection available now for purchase."
				/>
				<meta property="og:type" content="website" />
				<meta property="og:url" content="https://voni.us/returns" />
				<meta
					property="og:image"
			...
			{returns && (
				<div className="section-custom-border" dangerouslySetInnerHTML={{ __html: returns.body }}></div>
			)}
